...
def dashboard_stats():
    ...
    return jsonify({
        ...
        'defectueux': [{'id': a['id'], 'longueur_cm': a['longueur_cm'], 'timestamp': a['timestamp']} for a in defectueux],
        'ok': [{'id': a['id'], 'longueur_cm': a['longueur_cm'], 'timestamp': a['timestamp']} for a in ok]
    })
